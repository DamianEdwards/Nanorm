...
/// <summary>
/// Interface for statically creating an instance of <typeparamref name="T"/> from an <see cref="SqliteDataReader"/>.
/// </summary>
...
public interface IDataReaderMapper<T> where T : IDataReaderMapper<T>
{
    ...
    /// </summary>
    /// <param name="dataReader">The <see cref="SqliteDataReader"/>.</param>
